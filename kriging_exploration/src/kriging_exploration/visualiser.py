...
class KrigingVisualiser(object):
    ...
    def draw_topo_map(self, waypoints, alt_waypoints=None, colour='white', alt_colour='black', size=5, thickness=1):
        ...
        for i in alt_waypoints:
            self.topo_canvas.draw_coordinate(i.coord, alt_colour, size=size, thickness=thickness)
