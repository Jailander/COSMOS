...
#                print int(vmin+(ind*step))
                a= colmap.to_rgba(float(vmin+(ind*step)))                
...
#        cv2.putText(self.image, title, (230,175), font, 0.8, (220, 220, 220,255), 2)
        cv2.putText(self.image, title, (260,583), font, 0.8, (220, 220, 220,255), 2)    
